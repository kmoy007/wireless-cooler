...
class BLE_Peripheral : public IPeripheralDevice, public IBLEInterface, public std::enable_shared_from_this<BLE_Peripheral>
{
public:
	...
	bool ATCommand_GetResult(const std::string& command, std::vector<std::string>& returnStrings);
